...
main <- function(objectCounter = 300){
  library(MASS)
  ...
  colors <- c("red", "green")
  plot(xl[,1],xl[,2], pch = 21,main = "Наивный байесовский классификатор", xlab = 'feature 1', ylab= 'feature 2', col = colors[xl[,3]], asp = 1, bg=colors[xl[,3]])
